...
Class Layer_CONTRACT_Context_prf  := {
  ...
  CONTRACT_init_Contract_successfully_transferred_eq : Contract_successfully_transferred init_global_abstract_data = false;
...
Section OBJECT_Contract_DEFINITION.
  ...
  (* Object variables *)
  Definition Contract_successfully_transferred_var := {|
    ltype_tp_marker := tint_bool;

    ltype_ident := HighValues.Field HighValues.Global var_Contract_Contract_successfully_transferred_ident;
    ltype_ghost := false;

    ltype_get := Contract_successfully_transferred;
    ltype_set := update_Contract_successfully_transferred;
  ...
  Definition Contract_constructor := {|
    ...
    FC_body := (CCsequence
      (CCsequence
        (CCstore
          (LCvar Contract_successfully_transferred_var)
...
GlobalLayerSpec GetHighData  ZMap.get ZMap.set Int256Tree.t Int256Tree.get Int256Tree.set Int256Tree.empty  Int256Tree.get_default 
             ...
             Contract_successfully_transferred update_Contract_successfully_transferred ETH_successful_transfers update_ETH_successful_transfers]
...
Global Opaque Contract_constructor_opt.
  ...
  Definition Contract_ceip_example_ok := {|
    FC_ident_start := BuiltinBase_local_ident_start;
    FC_params := nil;
    FC_returns := void_unit_pair;
    FC_body := (CCsequence
  ...
  |}.
  Lemma Contract_ceip_example_ok_wf
      : synth_func_wellformed Contract_ceip_example_ok.
  Proof. solve_wellformed. Defined.
  Definition Contract_ceip_example_ok_opt : machine_env GetHighData -> DS unit  := 
  Eval cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
List.length is_true bool_dec
negb andb orb
...
GlobalLayerSpec GetHighData  ZMap.get ZMap.set Int256Tree.t Int256Tree.get Int256Tree.set Int256Tree.empty  Int256Tree.get_default 
             ...
             Contract_successfully_transferred update_Contract_successfully_transferred ETH_successful_transfers update_ETH_successful_transfers]
  in synth_func_spec_opt Contract_ceip_example_ok Contract_ceip_example_ok_wf.
  Definition Contract_ceip_example_ok_spec_hlist_opt args :=
    @apply_param_func Contract_ceip_example_ok.(FC_params) _
                      (Contract_ceip_example_ok_opt) args.
...
Lemma Contract_ceip_example_ok_CEI_AB : { rsts | function_constr_CEI_pattern_prf (fst rsts) Contract_ceip_example_ok (snd rsts)}.
Proof.
  unfold Contract_ceip_example_ok.
  CEI_auto_AB. (* If this tactic fails then it indicates that a strict version of the Checks-Effects-Interactions pattern was not followed in the function: Contract_ceip_example_ok. *)
Defined.

Lemma Contract_ceip_example_ok_CEI_BA : { rsts | function_constr_CEI_pattern_prf (fst rsts) Contract_ceip_example_ok (snd rsts)}.
Proof.
  unfold Contract_ceip_example_ok.
  CEI_auto_BA.
Defined.

Definition Contract_ceip_example_ok_CEI_rsts_before_A := fst (proj1_sig Contract_ceip_example_ok_CEI_AB).
Definition Contract_ceip_example_ok_CEI_rsts_after_A := snd (proj1_sig Contract_ceip_example_ok_CEI_AB).
Definition Contract_ceip_example_ok_CEI_rsts_before_B := fst (proj1_sig Contract_ceip_example_ok_CEI_BA).
Definition Contract_ceip_example_ok_CEI_rsts_after_B := snd (proj1_sig Contract_ceip_example_ok_CEI_BA).

  Definition Contract_ceip_example_ok_prim := {|
    PRIMident := ident_Contract_ceip_example_ok;
    (* PRIMcc := AST.cc_default; *)
    PRIMghost := false;
    PRIMpure := false;
    PRIMargt_marker := Contract_ceip_example_ok.(FC_params);
    PRIMret_marker := Contract_ceip_example_ok.(FC_returns);
    PRIMrst_before_A := Contract_ceip_example_ok_CEI_rsts_before_A;
    PRIMrst_after_A := Contract_ceip_example_ok_CEI_rsts_after_A;
    PRIMrst_before_B := Contract_ceip_example_ok_CEI_rsts_before_B;
    PRIMrst_after_B := Contract_ceip_example_ok_CEI_rsts_after_B;
    PRIMcond := fun _ _ _ => True;
    (* PRIMsem := Contract_ceip_example_ok_spec_hlist; *)
    PRIMsem_opt := Contract_ceip_example_ok_spec_hlist_opt
  |}.

  Lemma Contract_ceip_example_ok_spec_hlist_opt_eq :
    Contract_ceip_example_ok_spec_hlist_opt =
    fun args => apply_param_func
      (synth_func_spec_opt Contract_ceip_example_ok Contract_ceip_example_ok_wf)
      args.
  Proof.
    cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
...
GlobalLayerSpec GetHighData  ZMap.get ZMap.set Int256Tree.t Int256Tree.get Int256Tree.set Int256Tree.empty  Int256Tree.get_default 
     ...
     reflexivity.
  Qed.
  Definition Contract_ceip_example_ok_cfun :=
  Eval cbv in synth_func_func Contract_ceip_example_ok.

  Definition Contract_ceip_example_ok_cond  me d  :=
  Eval cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
List.length is_true bool_dec
negb andb orb
...
GlobalLayerSpec GetHighData  ZMap.get ZMap.set Int256Tree.t Int256Tree.get Int256Tree.set Int256Tree.empty  Int256Tree.get_default 
  ...
  Lemma Contract_ceip_example_ok_cond_eq : forall  me d, 
    Contract_ceip_example_ok_cond  me d ->
    high_level_invariant d ->
    synth_func_cond Contract_ceip_example_ok Contract_ceip_example_ok_wf  me d.
    Proof.
      intros  me d H_cond.
      cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
...
GlobalLayerSpec GetHighData  ZMap.get ZMap.set Int256Tree.t Int256Tree.get Int256Tree.set Int256Tree.empty  Int256Tree.get_default 
  ...
  Definition Contract_ceip_example_ok_obligation  me d  :=
  Eval cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
List.length is_true bool_dec
negb andb orb
...
GlobalLayerSpec GetHighData  ZMap.get ZMap.set Int256Tree.t Int256Tree.get Int256Tree.set Int256Tree.empty  Int256Tree.get_default 
  ...
  Lemma Contract_ceip_example_ok_obligation_eq : forall  me d, 
    Contract_ceip_example_ok_obligation  me d ->
    high_level_invariant d ->
    synth_func_obligation Contract_ceip_example_ok Contract_ceip_example_ok_wf  me d.
    Proof.
      intros  me d H_cond.
      cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
...
GlobalLayerSpec GetHighData  ZMap.get ZMap.set Int256Tree.t Int256Tree.get Int256Tree.set Int256Tree.empty  Int256Tree.get_default 
  ...
  Definition Contract_ceip_example_ok_spec :=
  Eval cbv [sf_mem sf_return fst snd Contract_ceip_example_ok_opt] in
    fun  me => execStateT (Contract_ceip_example_ok_opt me).
  Lemma Contract_ceip_example_ok_spec_eq :
    Contract_ceip_example_ok_spec =
    fun  me => execStateT (synth_func_spec_opt Contract_ceip_example_ok Contract_ceip_example_ok_wf me).
  Proof.
    cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
List.length is_true bool_dec
...
Global Opaque Contract_ceip_example_ok_opt.

  Definition Contract_ceip_example_not_ok := {|
    FC_ident_start := BuiltinBase_local_ident_start;
    FC_params := nil;
    FC_returns := void_unit_pair;
    FC_body := (CCstore
      ...
      (ECconst_int256 tint_bool true Int256.one))
  |}.
  Lemma Contract_ceip_example_not_ok_wf
      : synth_func_wellformed Contract_ceip_example_not_ok.
  Proof. solve_wellformed. Defined.
  Definition Contract_ceip_example_not_ok_opt : machine_env GetHighData -> DS unit  := 
  Eval cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
List.length is_true bool_dec
negb andb orb
...
GlobalLayerSpec GetHighData  ZMap.get ZMap.set Int256Tree.t Int256Tree.get Int256Tree.set Int256Tree.empty  Int256Tree.get_default 
             ...
             Contract_successfully_transferred update_Contract_successfully_transferred ETH_successful_transfers update_ETH_successful_transfers]
  in synth_func_spec_opt Contract_ceip_example_not_ok Contract_ceip_example_not_ok_wf.
  Definition Contract_ceip_example_not_ok_spec_hlist_opt args :=
    @apply_param_func Contract_ceip_example_not_ok.(FC_params) _
                      (Contract_ceip_example_not_ok_opt) args.
...
Lemma Contract_ceip_example_not_ok_CEI_AB : { rsts | function_constr_CEI_pattern_prf (fst rsts) Contract_ceip_example_not_ok (snd rsts)}.
Proof.
  unfold Contract_ceip_example_not_ok.
  CEI_auto_AB. (* If this tactic fails then it indicates that a strict version of the Checks-Effects-Interactions pattern was not followed in the function: Contract_ceip_example_not_ok. *)
Defined.

Lemma Contract_ceip_example_not_ok_CEI_BA : { rsts | function_constr_CEI_pattern_prf (fst rsts) Contract_ceip_example_not_ok (snd rsts)}.
Proof.
  unfold Contract_ceip_example_not_ok.
  CEI_auto_BA.
Defined.

Definition Contract_ceip_example_not_ok_CEI_rsts_before_A := fst (proj1_sig Contract_ceip_example_not_ok_CEI_AB).
Definition Contract_ceip_example_not_ok_CEI_rsts_after_A := snd (proj1_sig Contract_ceip_example_not_ok_CEI_AB).
Definition Contract_ceip_example_not_ok_CEI_rsts_before_B := fst (proj1_sig Contract_ceip_example_not_ok_CEI_BA).
Definition Contract_ceip_example_not_ok_CEI_rsts_after_B := snd (proj1_sig Contract_ceip_example_not_ok_CEI_BA).

  Definition Contract_ceip_example_not_ok_prim := {|
    PRIMident := ident_Contract_ceip_example_not_ok;
    (* PRIMcc := AST.cc_default; *)
    PRIMghost := false;
    PRIMpure := false;
    PRIMargt_marker := Contract_ceip_example_not_ok.(FC_params);
    PRIMret_marker := Contract_ceip_example_not_ok.(FC_returns);
    PRIMrst_before_A := Contract_ceip_example_not_ok_CEI_rsts_before_A;
    PRIMrst_after_A := Contract_ceip_example_not_ok_CEI_rsts_after_A;
    PRIMrst_before_B := Contract_ceip_example_not_ok_CEI_rsts_before_B;
    PRIMrst_after_B := Contract_ceip_example_not_ok_CEI_rsts_after_B;
    PRIMcond := fun _ _ _ => True;
    (* PRIMsem := Contract_ceip_example_not_ok_spec_hlist; *)
    PRIMsem_opt := Contract_ceip_example_not_ok_spec_hlist_opt
  |}.

  Lemma Contract_ceip_example_not_ok_spec_hlist_opt_eq :
    Contract_ceip_example_not_ok_spec_hlist_opt =
    fun args => apply_param_func
      (synth_func_spec_opt Contract_ceip_example_not_ok Contract_ceip_example_not_ok_wf)
      args.
  Proof.
    cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
...
GlobalLayerSpec GetHighData  ZMap.get ZMap.set Int256Tree.t Int256Tree.get Int256Tree.set Int256Tree.empty  Int256Tree.get_default 
     ...
     reflexivity.
  Qed.
  Definition Contract_ceip_example_not_ok_cfun :=
  Eval cbv in synth_func_func Contract_ceip_example_not_ok.

  Definition Contract_ceip_example_not_ok_cond  me d  :=
  Eval cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
List.length is_true bool_dec
negb andb orb
...
GlobalLayerSpec GetHighData  ZMap.get ZMap.set Int256Tree.t Int256Tree.get Int256Tree.set Int256Tree.empty  Int256Tree.get_default 
  ...
  Lemma Contract_ceip_example_not_ok_cond_eq : forall  me d, 
    Contract_ceip_example_not_ok_cond  me d ->
    high_level_invariant d ->
    synth_func_cond Contract_ceip_example_not_ok Contract_ceip_example_not_ok_wf  me d.
    Proof.
      intros  me d H_cond.
      cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
...
GlobalLayerSpec GetHighData  ZMap.get ZMap.set Int256Tree.t Int256Tree.get Int256Tree.set Int256Tree.empty  Int256Tree.get_default 
  ...
  Definition Contract_ceip_example_not_ok_obligation  me d  :=
  Eval cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
List.length is_true bool_dec
negb andb orb
...
GlobalLayerSpec GetHighData  ZMap.get ZMap.set Int256Tree.t Int256Tree.get Int256Tree.set Int256Tree.empty  Int256Tree.get_default 
  ...
  Lemma Contract_ceip_example_not_ok_obligation_eq : forall  me d, 
    Contract_ceip_example_not_ok_obligation  me d ->
    high_level_invariant d ->
    synth_func_obligation Contract_ceip_example_not_ok Contract_ceip_example_not_ok_wf  me d.
    Proof.
      intros  me d H_cond.
      cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
...
GlobalLayerSpec GetHighData  ZMap.get ZMap.set Int256Tree.t Int256Tree.get Int256Tree.set Int256Tree.empty  Int256Tree.get_default 
  ...
  Definition Contract_ceip_example_not_ok_spec :=
  Eval cbv [sf_mem sf_return fst snd Contract_ceip_example_not_ok_opt] in
    fun  me => execStateT (Contract_ceip_example_not_ok_opt me).
  Lemma Contract_ceip_example_not_ok_spec_eq :
    Contract_ceip_example_not_ok_spec =
    fun  me => execStateT (synth_func_spec_opt Contract_ceip_example_not_ok Contract_ceip_example_not_ok_wf me).
  Proof.
    cbv -[Int256.modulus zeq zle zlt Z.iter Z.le Z.lt Z.gt Z.ge Z.eqb Z.leb Z.ltb Z.geb Z.gtb Z.mul Z.div Z.modulo Z.add Z.sub Z.shiftl Z.shiftr Z.lxor Z.land Z.lor Z.of_nat
Int256.repr Int256.zero Int256.one Int256.add Int256.sub Int256.mul Int256.modu Int256.divu Int256.not Int256.and Int256.or Int256.xor Int256.shl Int256.shru Int256.eq Int256.lt Int256.ltu Ziteri 
List.length is_true bool_dec
...
Global Opaque Contract_ceip_example_not_ok_opt.
