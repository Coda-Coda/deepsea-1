...
rm -rf "$FILENAMENOEXT" # You may want to remove this line if you do not wish the folder to be deleted on every run of `compile_for_coq` e.g. if filling in some proofs within the auto-generated files.
