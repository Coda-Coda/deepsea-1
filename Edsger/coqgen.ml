...
(* output_hyper_binary_impl_eq, need to consider best way to generate Hbinary. *)
...
Definition update_Outgoing_transfer_recipient_and_amount new_outgoing_transfer_recipient_and_amount (glabs_a : global_abstract_data_type)
  := Build_global_abstract_data_type new_outgoing_transfer_recipient_and_amount ";
    iter_fields (fun o' f' ->
    ...
    iter_fields (fun o f ->
        ...
        output_string out (" (Outgoing_transfer_recipient_and_amount glabs_a) ");	
	iter_fields (fun o' f' ->
                      if (o' = o && f' = f)
  ...
  (* We can compute a new block by letting the players call the contract 
   ...
   Section Proof.   
     Context (* (strategies : strategy_tuple) *)
             (balances_at_start_of_call : addr -> Z)
...
(** Generates ContractModel.v - a file which defines helper functions useful when modelling the contract. *)
let gen_contract_model env fileDeclarations = 
  let stream = open_out (env.project_name ^ "/ContractModel.v") in

  output_string stream ("(*WARNING: This file is generated by Edsger, the DeepSEA compiler.
          All modification will be lost when regenerating. *)\n\n");
...
let coqgen filename ast =
  ...
  in gen_linksource_prelude env ast.aFileDeclarations;
     ...
     *)
     ...
     gen_contract_model env ast.aFileDeclarations;
#ifndef REDACTED
